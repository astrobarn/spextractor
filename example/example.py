...
z = 0.033
pew, pew_err, vel, vel_err, gp_model = spextractor.process_spectra(filename_Ib, z, downsampling=3, plot=True, type='Ib',sigma_outliers=3)
# velocities are given in 10**3 km/s and pEW in Å
print('pew (Å)')
report(pew, pew_err)
print('velocities (10**3 km/s)')
...
z = 0.011
pew, pew_err, vel, vel_err, gp_model = spextractor.process_spectra(filename_Ic, z, plot=True, type='Ic',sigma_outliers=3)
# velocities are given in 10**3 km/s and pEW in Å
print('pew (Å)')
report(pew, pew_err)
print('velocities (10**3 km/s)')
